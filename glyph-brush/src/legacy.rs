...
impl<'a> From<&crate::Text<'a>> for SectionText<'a> {
    #[inline]
    fn from(t: &crate::Text<'a>) -> Self {
        Self {
            text: t.text,
            scale: t.scale,
            color: t.extra.color,
...
impl<'a> From<VariedSection<'a>> for Cow<'a, crate::Section<'a>> {
    #[inline]
...
impl<'a, 'b> From<&'b VariedSection<'a>> for Cow<'b, crate::Section<'a>> {
    #[inline]
...
impl<'a> From<&crate::Section<'a>> for VariedSection<'a> {
    #[inline]
    fn from(s: &crate::Section<'a>) -> Self {
        Self {
            ...
            z: s.text.iter().nth(0).map(|t| t.extra.z).unwrap_or(0.0),
        }
    }
}
...
impl<'a> From<&Section<'a>> for crate::Section<'a> {
    fn from(s: &Section<'a>) -> Self {
        let Section {
            text,
            scale,
...
impl<'a> From<Section<'a>> for crate::Section<'a> {
    fn from(s: Section<'a>) -> Self {
        crate::Section::from(&s)
    }
}

impl<'a> From<Section<'a>> for Cow<'a, crate::Section<'a>> {
    fn from(section: Section<'a>) -> Self {
        Cow::Owned(crate::Section::from(section))
    }
}
...
impl<'a> From<&'a OwnedVariedSection> for crate::Section<'a> {
    #[inline]
    fn from(owned: &'a OwnedVariedSection) -> Self {
...
impl<'a> From<&'a OwnedVariedSection> for Cow<'a, crate::Section<'a>> {
    #[inline]
    fn from(owned: &'a OwnedVariedSection) -> Self {
